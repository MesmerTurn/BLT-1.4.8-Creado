    ...
    if(typeof $.connection.missionInfoHub !== 'undefined') {
        ...
        for (let i = 0; i < 20; i++) {
            ...
            mission.heroes.push({
                ...
                Retinue2: Math.floor(Math.random() * 5),
                DeadRetinue2: Math.floor(Math.random() * 5),
                ...
                CompanionCount: Math.floor(Math.random() * 4),
                AdrenalineFractionRemaining: Math.random(),
            });
        }
        // mission.heroes = [
        //     {
