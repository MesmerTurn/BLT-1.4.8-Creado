...
namespace BannerlordTwitch.Helpers
{
    public enum EquipmentType
    {
        ...
        [LocDisplayName("{=TESTING}Musket")] Musket,
        [LocDisplayName("{=TESTING}Pistol")] Pistol,
        [LocDisplayName("{=TESTING}Bullets")] Bullets,
        Num,
    }
    ...
    public class EquipmentTypeItemSource : IItemsSource
    {
        private static readonly ItemCollection items = new()
        {
            ...
            { EquipmentType.Musket, "Musket".Translate() },
            { EquipmentType.Pistol, "Pistol".Translate() },
            { EquipmentType.Bullets, "Bullets".Translate() },
        };
    ...
    public static class EquipmentTypeHelpers
    {
        ...
        public static bool IsEquipmentType(this ItemObject item, EquipmentType equipmentType)
        {
            return equipmentType switch
            {
                ...
                EquipmentType.Musket => item.ItemType == ItemObject.ItemTypeEnum.Musket,
                EquipmentType.Pistol => item.ItemType == ItemObject.ItemTypeEnum.Pistol,
                EquipmentType.Bullets => item.ItemType == ItemObject.ItemTypeEnum.Bullets,
        ...
        public static WeaponClass GetWeaponClass(EquipmentType equipmentType) =>
            equipmentType switch
            {
                ...
                EquipmentType.Musket => WeaponClass.Musket,
                EquipmentType.Pistol => WeaponClass.Pistol,
                EquipmentType.Bullets => WeaponClass.Cartridge,
                _ => throw new ArgumentOutOfRangeException(nameof(equipmentType), equipmentType, null)
            };
    }
}